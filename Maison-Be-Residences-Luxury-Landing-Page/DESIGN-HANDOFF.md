# 4a25a22c-20a0-4dda-8d18-3209170ed3ba implementation handoff

This archive is the source of truth for turning the design into production code. Start from `maison-be-residences-2.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `maison-be-residences-2.html`
...
- A single self-contained `maison-be-residences-2.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `maison-be-residences-2.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `maison-be-residences-2.html`
- `maison-be-residences-3-2.html`
- `maison-be-residences-3.html`
- `maison-be-residences-4.html`
- `maison-be-residences-5.html`
- `maison-be-residences-6.html`
- `maison-be-residences-prata-2.html`
- `maison-be-residences-prata-3.html`
- `maison-be-residences-prata-hero-2.html`
- `maison-be-residences-prata-hero-3.html`
- `maison-be-residences-prata-hero.html`
- `maison-be-residences-prata.html`
- `maison-be-residences.html`
...
1. Inspect `maison-be-residences-2.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
